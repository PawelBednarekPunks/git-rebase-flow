# Proces Gitflow: od zadania do wdrożenia
...
Po przejrzeniu historii przećwicz konflikty, selektywne wydanie, tagi i
promocję artefaktu w [izolowanym laboratorium](cwiczenia-gitflow.md).
